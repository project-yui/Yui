...
## NodeIGetLocalStorageBackupCallback
...
## NodeIRobotStoreCategoryListCallback
...
## NodeICollectionArkShareCallback
...
## NodeIQQNTWrapperNetworkListener
...
## NodeIGProLoadGuildAndChnListCallback
...
## NodeIGProSetGuildCoverFontColorIdCallback
...
## NodeIGProSetGuildAdminResultCallback
...
## NodeIGProLoadGuildUserProfileCallback
...
## NodeIGProFetchAudioLiveGroupListCallback
...
## NodeIGProStickyChannelCallback
...
## NodeIGProFetchChannelListForJumpCallback
...
## NodeIGProFetchProfileAddFriendFieldCallback
...
## NodeIGProFetchChannelLiveableRoleListCallback
...
## NodeIGProChannelUserPermissionCallback
...
## NodeIGProTerminateLiveStreamCallback
...
## NodeIGProQueryTinyIdByLiveUIDCallback
...
## NodeIGProCreateDirectMsgSessionCallback
...
## NodeIGProGetScheduleListCallback
...
## NodeIGProFetchJubaoMsgsResIdCallback
...
## NodeIGProGetRtmpPushUrlCallback
...
## NodeIGProGetInvitationGuildCallback
...
## NodeIGProAssociativeWordsCallback
...
## NodeIGProSetQQMsgListGuildCallback
...
## NodeIGProVoiceSmobaGameCreateRoomCallback
...
## NodeIGProUserOnlineReportCallback
...
## NodeIGProFetchRetentionGuildListCallback
...
## NodeIGProConvertGuildAndThirdIdCallback
...
## NodeIGProGetDiscoverRecommendGuildsCallback
...
## NodeIGProGetRecommendQuickJoinCallback
...
## NodeIGProGetCategoryChannelInfoListV2Callback
...
## NodeIGProVoiceSmobaGameGetRoomByChannelCallback
...
## NodeIKernelRDeliveryOperateCallback
...
## NodeIGProLoadSideBarConfigCallback
...
| updateRecentContactExtBufForUI | |
| setContactListTop | |
| getContacts | |
...
## NodeIGetServiceAssistantSwitchCallback
...
| updateAnonymousInfo | |
| sendSummonMsg | |
| outputGuildUnreadInfo | |
| checkMsgWithUrl | |
| checkTabListStatus | |
| getABatchOfContactMsgBoxInfo | |
| insertMsgToMsgBox | |
| isHitEmojiKeyword | |
| getKeyWordRelatedEmoji | |
| recordEmoji | |
| fetchGetHitEmotionsByWord | |
| deleteAllRoamMsgs | |
| packRedBag | |
| grabRedBag | |
| pullDetail | |
| selectPasswordRedBag | |
| pullRedBagPasswordList | |
| requestTianshuAdv | |
| tianshuReport | |
| tianshuMultiReport | |
| GetMsgSubType | |
| setIKernelPublicAccountAdapter | |
| createUidFromTinyId | |
| dataMigrationGetDataAvaiableContactList | |
| dataMigrationGetMsgList | |
| dataMigrationStopOperation | |
| dataMigrationImportMsgPbRecord | |
| dataMigrationGetResourceLocalDestinyPath | |
| dataMigrationSetIOSPathPrefix | |
| getServiceAssistantSwitch | |
| setServiceAssistantSwitch | |
| setSubscribeFolderUsingSmallRedPoint | |
| clearGuildNoticeRedPoint | |
| clearFeedNoticeRedPoint | |
| clearFeedSquareRead | |
| IsC2CStyleChatType | |
| IsTempChatType | |
| getGuildInteractiveNotification | |
| getGuildNotificationAbstract | |
| setFocusOnBase | |
| queryArkInfo | |
| queryUserSecQuality | |
| isNull | |
...
## NodeIAddJsonGrayTipMsgCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetMultiMsgCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIMsgOperateCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetAioFirstViewLatestMsgCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIQueryMsgsWithFilterVer2Callback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIQueryMsgsAndAbstractsWithFilterCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetMsgWithAbstractCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIForwardOperateCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIMatchedOperateCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIUnreadCntCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIJoinGuildCntCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGProGetRecentUseEmojiListCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGProSetMsgEmojiLikesCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGProSetMsgEmojiLikesForRoleCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGProGetMsgEmojiLikesListCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGProGetMsgAbstractsCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGProGetHotPicInfoListCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGProFetchFavEmojiListCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIModifyFavEmojiDescCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIFetchMarketEmoticonListCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetMarketEmoticonPathCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetFavMarketEmoticonInfoCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetMarketEmoticonEncryptKeysCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetRecentUsedFaceListCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetMsgSeqCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIFetchChannelLatestSeqCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIFetchNavigateInfoCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGProRecallCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGProMiscStorageGetCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGProSimpleCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIBookmarkStorageGetCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIQueryCalendarCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIQueryFirstMsgSeqCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIQueryFirstRoamMsgCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetDraftOperateCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetFirstUnreadAtMsgCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIClearMsgRecordsCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeISwitchAnonymousChatCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIRenameAnonymousChatNickCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetMsgQRCodeCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetGuildBinaryDataCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetGuildGroupBubbleCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIClickInlineKeyboardButtonCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIAddFavEmojiCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetTempChatInfoCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetEmojiResourcePathCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIJoinDragonGroupCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetStatusMsgCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIDownloadCommonStatusCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeICheckMsgWithUrlCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGuestMsgOperateCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGuestGetMsgAbstractsCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeICheckChannelEntranceCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetMsgsBoxesCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIOperateHiddenSessionCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIFetchGetHitEmotionsByWordCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIDataMigrationGetAvailableContactListCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIDataMigrationGetMsgListCalback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIPackRedBagCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGrabRedBagCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIPullDetailCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIPullRedBagPasswordListCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetAutoReplyTextListCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeITianShuGetAdvCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeICanImportCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeITempChatSigListener

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIDataImportTableNamesCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetMsgWithStatusCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIKernelQueryArkInfoCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGuildInteractiveNotificationCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGuildNotificationAbstractCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIQueryUserSecQualityCallback
...
| modifyGroupName | |
| modifyGroupRemark | |
| modifyGroupDetailInfo | |
| setGroupMsgMask | |
| changeGroupShieldSettingTemp | |
| inviteToGroup | |
| inviteMembersToGroup | |
| inviteMembersToGroupWithMsg | |
| createGroup | |
...
| publishInstructionForNewcomers | |
| uploadGroupBulletinPic | |
| downloadGroupBulletinRichMedia | |
| getGroupBulletinList | |
| getGroupStatisticInfo | |
...
## NodeIKickMemberOperateCallback
...
## NodeICreateGroupOperateCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeICreateGroupCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIUploadGroupBulletinPicCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetGroupRemainAtAllTimesOperateCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetTransferableMemberCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIDiscussSimpleInfoCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetGroupRecommendContactArkJsonCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGetJoinGroupLinkCallback
...
## NodeIKernelSearchCacheProxy

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeILoadSearchHistoryCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIAddSearchHistoryCallback
...
| removeKernelSearchListener | |
| searchStranger | |
| searchGroup | |
| searchLocalInfo | |
| cancelSearchLocalInfo | |
| searchBuddyChatInfo | |
| searchMoreBuddyChatInfo | |
| cancelSearchBuddyChatInfo | |
| searchGroupChatInfo | |
| resetSearchGroupChatInfoSortType | |
| resetSearchGroupChatInfoFilterMembers | |
| searchMoreGroupChatInfo | |
| cancelSearchGroupChatInfo | |
| searchChatsWithKeywords | |
| searchMoreChatsWithKeywords | |
| cancelSearchChatsWithKeywords | |
| searchChatMsgs | |
| searchMoreChatMsgs | |
| cancelSearchChatMsgs | |
| searchMsgWithKeywords | |
| searchMoreMsgWithKeywords | |
| cancelSearchMsgWithKeywords | |
...
## NodeIOperateCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeITaskFinishCallback
...
| getAddMeSetting | |
| getDoubtBuddyReq | |
| getDoubtBuddyUnreadNum | |
| approvalDoubtBuddyReq | |
| delDoubtBuddyReq | |
| delAllDoubtBuddyReq | |
| reportDoubtBuddyReqUnread | |
...
## NodeIGetBuddyRecommendContactArkJsonCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeILoadProxyConfigCallback
...
| getMsfStatus | |
| getNetworkProxy | |
| getBrowserAndSetLocalProxy | |
| setNetworkProxy | |
| setNetworkProxySaveDir | |
...
| 方法名 | 描述 |
|-------|-----|
| addKernelNodeMiscListener | |
| removeKernelNodeMiscListener | |
| startSession | |
| encodeAES | |
| getUserDataDir | |
| setCurActiveGuildAndChannel | |
| setCurWindowsStatus | |
| sendLog | |
| openPictureUsingQQ | |
| initScreenShotPlugin | |
| setScreenShotSetting | |
| wantScreenShot | |
| wantScreenShotWithLinuxX11Lib | |
| wantScreenRecording | |
| startScreenShotInstance | |
| wantScreenShotNT | |
| wantScreenRecordingNT | |
| wantScreenOCR | |
| wantWinScreenOCR | |
| cancelOCRImage | |
| registerScreenRecordShortcutWithKeycode | |
| registerScreenCaptureShortcutWithKeycode | |
| unregisterHotkey | |
| isScreenCaptureOrRecording | |
| getGetFullScreenInfo | |
| isAppInstalled | |
| installApp | |
| startNewApp | |
| sendRequestToApiGateway | |
| getOpenAuth | |
| getOpenAuthDelegateCode | |
| wantParseClipboard | |
| mainWindowInitComplete | |
| notifyGuildHasHiddenDock | |
| changeSendKey | |
| getSendKey | |
| needRelaunchQQGuild | |
| getNodeAndQQIPCVersions | |
| getRelaunchParams | |
| writeClipboard | |
| checkIfHaveAvailableSidecarDevice | |
| openSidecarMenu | |
| startNewAppInstance | |
| startNewMiniApp | |
| sendMiniAppMsg | |
...
## NodeIGProParseClipboardCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGProWriteClipboardCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGProGetSendKeyCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeISendRequestToApiGatewayCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGProGetRelaunchParamsCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGProGetLinuxScreenShotCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGuildHotUpdateListener
...
| 方法名 | 描述 |
|-------|-----|
| addHotUpdateListener | |
| removeHotUpdateListener | |
| isNull | |

## NodeIStartMiniAppCallback
...
## NodeIMiniAppCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIOpenFileAndDirSelectDlgCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIOpenAuthCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIOpenAuthDelegateCodeCallback
...
| 方法名 | 描述 |
|-------|-----|
| addKernelRemotingListener | |
| removeKernelRemotingListener | |
| setPenetrateBuffer | |
| startRemotingClient | |
| startRemotingInvite | |
| stopRemoting | |
...
## NodeIKernelAVSDKListener

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeIGroupVideoCmdRequestRsp
...
## NodeILoginMiscDataGetCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeILoginMiscDataSetCallback

| 方法名 | 描述 |
|-------|-----|
| New | |

## NodeILoginListCallback
