...
import { calculateFileMd5, calculateFileSha1, int2IPNet } from "../../common/utils";
import { sendCustomPkgV2 } from "../../native/native";
import { getCurrentNTUserInfo } from "../../ntqq/core/runtime-store";
import { PicHighwayUpload } from "../../ntqq/core/highway/pic-highway";
import { getHttpTicket } from "../../ntqq/message/http-ticket";
...
import { IPAddressInfo, ReqUploadGroupPicPrepare, RspBodyField6, RspUploadGroupPicPrepare } from "../../ntqq/protobuf/pic_upload";
import { BotMessageSendElements } from "../../onebot/contracts/message";
import type { BotMessage } from "../../onebot/contracts/message";
...
export class ForwardConverter {
    ...
    async uploadImage() {
        const user = getCurrentNTUserInfo()
