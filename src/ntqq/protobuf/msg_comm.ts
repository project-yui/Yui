...
export const protobufPackage = "msg_comm";

export interface ContentHead {
  pkgNum?: number | undefined;
  pkgIndex?: number | undefined;
  divSeq?: number | undefined;
  autoReply?: number | undefined;
}

function createBaseContentHead(): ContentHead {
  return { pkgNum: undefined, pkgIndex: undefined, divSeq: undefined, autoReply: undefined };
}
...
export const ContentHead: MessageFns<ContentHead> = {
  encode(message: ContentHead, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pkgNum !== undefined) {
      writer.uint32(8).uint32(message.pkgNum);
    }
    if (message.pkgIndex !== undefined) {
      writer.uint32(16).uint32(message.pkgIndex);
    }
    if (message.divSeq !== undefined) {
      writer.uint32(24).uint32(message.divSeq);
    }
    if (message.autoReply !== undefined) {
      writer.uint32(32).uint32(message.autoReply);
    }
    return writer;
  },
